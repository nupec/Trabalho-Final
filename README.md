# Trabalho Final de R para Ciências de Dados II
...
Calcula a relação entre a matricula em creches de crianças de 0 a 3 anos, e população de uma determinada cidade.

## Indicador 1A

Calcula a relação entre a matricula de crinças da pré-escola (4 e 5 anos), e população correspondente desta faixa-etária.

## Base de dados utilizadas

### 1) Censo Escolar

Analisou-se a matrícula dos alunos da região Norte do Brasil e, consolidou-se os dados de 7 (sete) cidade do interior do estado do Amazonas. A partir desta base, foi possível levantar o total de crianças matriculadas nas duas faixas-etária de interesse, 0 a 3 anos e 4 a 5 anos.

### 2) Estimativa da População Brasileira

Paa o cálculo dos indicadores é imprescidível a consolidação da população em faixas-etárias bem específicas. Entretanto, os dados não possuem esse nível de desagregação a nível municipal. Para contornar esse problema, utilizou-se os dados desagregados por idade da população brasileira, da qual calculou-se o índice que foi usado para estimar a distribuição por idade, nos municípios.
